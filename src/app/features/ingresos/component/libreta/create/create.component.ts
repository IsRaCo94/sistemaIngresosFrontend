...
export class CreateComponent implements OnInit {
  ...
  guardarRegistro() {
   this.submitted = true;
    ...
    this.nuevaLibreta.des_libreta,
    this.nuevaLibreta.des_corta_libreta,
    this.nuevaLibreta.libreta
    ];
  ...
  this.libretaService.postLibreta(this.nuevaLibreta)
    .subscribe({ 
      next: (res: any) => {
        this.isLoading = false;
        this.button = 'Guardar';
        Swal.fire('Registro Exitoso', res.message || 'La libreta se registró correctamente.', 'success');
        this.goBack(); 
      },
